...
export const Step13: LessonStep = {
    ...
    content: null,
    subsections: [
        { at: 0, title: "Newton's Third Law", content: <p>For every action, there is an equal and opposite reaction. Sir Isaac Newton figured this out for apples and planets three hundred years ago, and today we apply it to thoughts and predictions.</p> },
        { at: 35, title: "The Loop", content: <div className="space-y-4">
            <p>Our force equations satisfy Newton's Third Law perfectly. In the context of Predictive Coding, this creates a profound symmetry called <strong>Reciprocity</strong>. It solves a major problem. In many AI models, data flows one way: from input to output.</p>
        </div>},
        { at: 70, title: "Push and Pull", content: <div className="space-y-4">
             <p>But in the brain—and in our model—it is a two-way street. While the sensory data is pushing the internal model to change, the internal model is pushing back. We do not just passively see the world; we project our expectations onto it. This physical tug-of-war is the loop of consciousness.</p>
        </div>}
    ],
